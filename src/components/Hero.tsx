  ...
  return (
    <section id="hero" className="pt-24 pb-12 section-padding relative overflow-hidden">
      ...
      <div className="container-max">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 xl:gap-32 items-start">
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                className="rounded-2xl shadow-2xl w-full h-[300px] sm:h-[400px] lg:h-[500px] object-cover transition-transform duration-700"
              />
              ...
              {proofBubbles.map((bubble, index) => (
                <motion.div
                  key={index}
                  className="absolute glass-card px-2 sm:px-3 lg:px-4 py-2 sm:py-3 shadow-xl flex items-center space-x-1 sm:space-x-2 hover:scale-110 transition-transform duration-300 hidden sm:flex"
                  style={{
                    top: `${20 + index * 25}%`,
                ...
                >
                  <bubble.icon className="w-4 h-4 sm:w-5 sm:h-5 text-primary" />
          ...
          >
            <div className="space-y-6">
              ...
              <motion.h1
                className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight text-reveal text-center"
                initial={{ y: 100, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 1, delay: 0.2, ease: 'easeOut' }}
              >
                تعلّم الإنجليزية بثقة...{' '}
                <span className="gradient-text">ودّع الارتباك في المقابلات والمكالمات والاجتماعات</span>
              </motion.h1>

              <motion.p
                className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed text-center"
            ...
            >
              <button
                ...
                className="btn-primary text-sm sm:text-base lg:text-lg pulse-glow text-center min-h-[44px] touch-manipulation"
              >
